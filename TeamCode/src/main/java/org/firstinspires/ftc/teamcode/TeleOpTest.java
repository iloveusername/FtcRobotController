...
public class TeleOpTest extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if(stickX > -0.25 && stickX< 0.25){
                roboState = "drive";
            }
            if(stickX > 0.25){
                if(stickY > 0.25 || stickY < -0.25){
                    roboState = "tiltRight";
                }
            }
            if(stickX < 0.25){
            ...
            switch (roboState){
                ...
                case "tiltRight":
                    wheelDirection("up");
                    leftDrive.setPower(-stickX);
                    rightDrive.setPower(-stickX * 0.75);
                    BleftDrive.setPower(-stickX);
                    BrightDrive.setPower(-stickX * 0.75);
                case "tiltLeft":
                    wheelDirection("up");
                    leftDrive.setPower(-stickX * 0.75);
                    rightDrive.setPower(-stickX);
                    BleftDrive.setPower(-stickX * 0.75);
                    BrightDrive.setPower(-stickX);
