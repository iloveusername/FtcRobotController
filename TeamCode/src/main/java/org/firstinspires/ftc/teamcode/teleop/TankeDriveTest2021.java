...
@TeleOp(name="TeleOp Tank Drive", group="Basic")
public class TankeDriveTest2021 extends LinearOpMode {
    //Motors
    ...
    public void runOpMode(){
        ...
        while (opModeIsActive()){
            ...
            leftDrive.setPower(stickL);
            BleftDrive.setPower(stickL);
            rightDrive.setPower(stickR);
            BrightDrive.setPower(stickR);

            telemetry.addData("FL Encoder", leftDrive.getCurrentPosition());
            telemetry.addData("FR Encoder", rightDrive.getCurrentPosition());
            telemetry.update();
        }
